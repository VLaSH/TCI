...
--
-- Host: localhost    Database: tci_dev
-- ------------------------------------------------------
...
CREATE TABLE `courses` (
  ...
  `category_5` tinyint(1) DEFAULT '0',
...
CREATE TABLE `reviews` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_reviews_on_student_user_id` (`student_user_id`),
  KEY `index_reviews_on_course_id` (`course_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scheduled_lessons` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_scheduled_course_id` (`scheduled_course_id`),
  KEY `index_scheduled_lessons_on_student_user_id` (`student_user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `schema_migrations` VALUES ('20090122142713'),('20090122215934'),('20090128113227'),('20090128121716'),('20090128121741'),('20090128121814'),('20090128170019'),('20090129163459'),('20090129211056'),('20090129211338'),('20090129211459'),('20090129213726'),('20090129213848'),('20090202130215'),('20090202130958'),('20090202131220'),('20090202175000'),('20090202215839'),('20090202220828'),('20090203185032'),('20090205174751'),('20090205174834'),('20090205222303'),('20090206164315'),('20090216131542'),('20090218192346'),('20090219104818'),('20090219144617'),('20090219161628'),('20090326155648'),('20090326155649'),('20090611222317'),('20090623150825'),('20090706215310'),('20100919230642'),('20101001110013'),('20101005004821'),('20101006225827'),('20101007231343'),('20101102133306'),('20101102135916'),('20101102192112'),('20101212230846'),('20101213003325'),('20101216003627'),('20110118191219'),('20110118213931'),('20110118214724'),('20110118214853'),('20110217215204'),('20110218002326'),('20110509210301'),('20110618221625'),('20110705083646'),('20120510071847'),('20120518114824'),('20120705113536'),('20130214221346'),('20130527225000'),('20140930161326'),('20141001145206'),('20141007114352'),('20141009072128'),('20141011065822'),('20141015111310'),('20141021111930'),('20141027134133'),('20141029104434'),('20141029140306'),('20141101052302'),('20141101111723'),('20141102102540'),('20141102111454'),('20141103072328'),('20141106075423'),('20141127112134'),('20141127121236'),('20141203102752'),('20141215132100'),('20141231094732'),('20150106062055'),('20150106100439'),('20150114144501'),('20150129152536'),('20150219120620'),('20150227054226'),('20150424145652'),('20150504112748'),('20150506124928'),('20150506130349'),('20150507081039'),('20150507090026');
...
DROP TABLE IF EXISTS `student_galleries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `student_galleries` WRITE;
/*!40000 ALTER TABLE `student_galleries` DISABLE KEYS */;
/*!40000 ALTER TABLE `student_galleries` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users` (
  ...
  `custom_video_code` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2015-07-21 13:57:18
