  ...
  def instructor_image
    if @instructor
      if !@instructor.vimeo_video_id.blank?
        content_tag :iframe, nil, src: "https://player.vimeo.com/video/#{@instructor.vimeo_video_id}?title=0&amp;byline=0&amp;portrait=0&amp;color=0c88dd", width: 660, height: 440, frameborder: 0, webkitAllowFullScreen: '', mozallowfullscreen: '', allowFullScreen: ''
      elsif !@instructor.youtube_video_id.blank?
        content_tag :iframe, nil, width: 660, height: 440, src: "https://www.youtube.com/embed/#{@instructor.youtube_video_id}?rel=0", allowfullscreen: ''
