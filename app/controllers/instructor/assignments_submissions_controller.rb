class Instructor::AssignmentsSubmissionsController < Instructor::BaseController
  ...
  def show
    ...
    @assignment_submission.instructor_unread = 0
  ...
  def sequence
    @assignment_submission.instructor_rearrangement = params[:sequence]
    @assignment_submission.save!
    redirect_to instructor_submission_path(@assignment_submission)
  end
